...
:white_check_mark: Выбор желаемого качества видео\
:white_check_mark: Выбор из доступных озвучек фильма/сериала\
:white_check_mark: Возможность загрузки всего сериала целиком\
:white_check_mark: Возможность начать загрузку сериала с любой серии и сезона\
:black_square_button: Возможности загрузить только один сезон\
:black_square_button: Загрузку субтитров\
:black_square_button: Выбор языка субтитров
### Установка
---
