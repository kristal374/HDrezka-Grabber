...
function blobIsLoad() {
    return new Promise((resolve) => {
        const script = document.querySelector('script[src*="injection_scripts/Blob.js"]');
        if (script) {
            resolve(true);
        } else { resolve(false) }
    });
...
function loadBlob() {
    return new Promise((resolve) => {
        ...
        script.src = chrome.runtime.getURL('injection_scripts/Blob.js');
...
function injectLoader(videoSettings) {
    return new Promise((resolve) => {
        const script = document.createElement('script');
        script.src = chrome.runtime.getURL('injection_scripts/loader.js');
