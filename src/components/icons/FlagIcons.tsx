export function FlagIcon({
  ...
  switch (country) {
    ...
    case 'ge':
      return <FlagGE className={className} />;
    default:
      return null;
  }
}
...
export function FlagGE({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <rect x='6.75' width='2.5' height='11' fill='#FF0000' />
      <rect y='4.25' width='16' height='2.5' fill='#FF0000' />
      <rect x='3' y='1.75' width='1' height='1' fill='#FF0000' />
      <rect x='3' y='8.25' width='1' height='1' fill='#FF0000' />
      <rect x='12' y='1.75' width='1' height='1' fill='#FF0000' />
      <rect x='12' y='8.25' width='1' height='1' fill='#FF0000' />
    </svg>
  );
}
